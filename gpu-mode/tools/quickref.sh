...
echo "  ./target/release/popcorn-cli submit \\"
echo "    --gpu MI355X \\"
echo "    --leaderboard mxfp4-mm \\"
echo "    --mode leaderboard \\"
echo "    ~/$WORKSPACE/submissions/mxfp4_mm_starter.py"
echo ""
echo "OTHER AMD QUALIFIER LEADERBOARDS:"
echo "  - mla-py"
echo "  - 3_moe_mxfp4"
echo ""
...
echo "  - MI355X, A100, H100, B200, etc."
...
echo "  ROCm Docs:     https://rocm.docs.amd.com"
