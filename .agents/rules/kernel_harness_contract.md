...
- A new kernel is incomplete until `Readme.md` lists it, identifies its backend
  coverage, and documents non-default build or run requirements.
...
4. Does `Readme.md` accurately describe the new kernel and how to run it?
